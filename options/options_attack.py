class  opts_ntu_60_cross_view():
  ...
  # graph based model
   ...
   self.test_feeder_args = {
       ...
       'num_frame_path': './NTU-RGB-D-60-AGCN/xview/val_num_frame.npy',
...
class opts_hdm05():
    ...
    def __init__(self):
        ...
        self.train_feeder_args = {
            ...
            'data_path': './data/hdm05/classTrain.npz',
        ...
        self.test_feeder_args = {
            ...
            'data_path': './data/hdm05/classTest.npz',
            'label_path': './data/NTU-RGB-D-60-AGCN/xview/val_label.pkl',
            # 'label_path': './data/ntu/xview/nobox10_label.pkl',
